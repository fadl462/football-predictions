...
export default async function Home() {
  const { matches, predictions, affiliate, freeCount, vipCount } = await homeData();
  return <main>{process.env.DEMO_MODE === 'true' && <div className="demoBanner">Mode démo — les matchs et pronostics affichés sont des exemples jusqu’à la connexion de la base de données et de l’API football.</div>}
    <section className="hero"><div className="container">
      ...
      <div className="stats"><div className="stat"><strong>{freeCount}</strong><span>Pronostics gratuits / jour</span></div><div className="stat"><strong>68%+</strong><span>Seuil de confiance minimum</span></div><div className="stat"><strong>🇩🇿 DZ</strong><span>Ligue 1 & Ligue 2 prioritaires</span></div><div className="stat"><strong>24/7</strong><span>Synchronisation automatique</span></div></div>
    </div></section>
